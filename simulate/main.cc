            ...
            else
            {
                     ...
                     (Glfw().glfwGetTime() - startCPU) < refreshTime)
              {
                ...
                if (initialpos == true)
                {
                  ...
                  d->qpos[7] = 0.04;
                  d->qpos[8] = 0.04;
                  d->qpos[10] = 90.0 *DEG2RAD;
                   
                  // d->qpos[5] = 30.0 * DEG2RAD; // to avoid self collision
                  // d->qpos[7] = 0.04; // to avoid self collision
                  // d->qpos[8] = 0.04; // to avoid self collision
                  initialpos = false;
                }
                else
                {
...
int main(int argc, const char **argv)
{
  ...
  // char str[100] = "/home/kist-robot2/Franka/franka_rrt/model/franka_emika_panda/scene_valve.xml";
  char str[100] = "/home/kist-robot2/Franka/franka_rrt/model/franka_door/scene_door.xml";
  filename = str;
